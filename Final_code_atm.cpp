...
int update1(string  acno , string names , string pind, int balas){
 ...
 ofstream out("accounts.txt", ios::app);
  out <<endl<<acno<<" "<<names<<" "<<pind<<" "<<balas;
  return 0;
...
int update2(int deno, int curramnt, int currval){
 ...
 ofstream out("balance.txt", ios::app);
  out <<endl<<deno<<"   "<<curramnt<<"  "<<currval;
  return 0;
...
int total_transfer( string accno2,int  transfer, string accno, string username,string pino,int linecount1,string f1, string f2){
                   ...
                   if(bala1>=0){
                    ...
                    mini_update_transfer_from(f2,accno,accno2,transfer,bala1);
                    mini_update_transfer_to(f1,accno,accno2,transfer,bala2);
                     }
    ...
    do{ 
        ...
        if(fleg==1)
           ...
           switch(op2){
                ...
                case 1:
                {
                    int realbala = checkaccount(accno);
                ...
                case 3:
                {
                    int transfer;
                    string accno2;
                    cout<<"\n Please enter the account number to transfer the amount : ";
                    cin>>accno2;
                ...
                cout<<"\n Please enter the ATM Administrator Password to view the ATM balance :";
                cin>>adminpass;
                showatmbalance(adminpass);     
